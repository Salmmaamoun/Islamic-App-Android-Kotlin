...
class QuranFragment : Fragment() {
    ...
    val suraNameList=listOf<String>("الفاتحه","البقرة","آل عمران","النساء","المائدة","الأنعام","الأعراف","الأنفال","التوبة","يونس","هود"
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
         recyclerView=view.findViewById<RecyclerView>(R.id.suraNameRecyclerView)
        suraNameAdapter=SuraNameAdapter(suraNameList)
        suraNameAdapter.onitemClick=object :SuraNameAdapter.OnitemClick{
            override fun onSuraNameClick(sura: String, position: Int) {
               val intent1=Intent( requireActivity(),SuraDetailsActivity::class.java)
                ...
                intent1.putExtra("EXTRA_SURA_NAME",sura)
